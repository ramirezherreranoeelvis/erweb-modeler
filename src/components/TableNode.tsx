...
const TableNode: React.FC<TableNodeProps> = ({
      ...
      const handleTableNameSubmit = () => {
            if (
                  editTableNameValue.trim() &&
                  !isDuplicateName(editTableNameValue)
            ) {
                  onUpdateTable(
                        table.id,
                        "name",
                        editTableNameValue.toUpperCase(),
                  );
            } else {
                  setEditTableNameValue(table.name);
            }
                        ...
                        <div className="flex-1 min-w-0 mr-2">
                              {isEditingTableName ? (
                                    ...
                                    <div
                                          ...
                                          title={
                                                isLocked
                                                      ? "Table locked. Double click to rename"
                        ...
                        {table.columns.map((col, index) => (
                              ...
                              >
                                    ...
                                    {!col.isFk && (
                                          <>
                                                <div
                                                      className="hidden group-hover/row:block absolute -left-1.5 top-1/2 -translate-y-1/2 w-3 h-3 bg-blue-500 border-2 border-white dark:border-slate-800 rounded-full cursor-crosshair shadow-sm z-20 hover:scale-125 transition-transform"
                                                      onMouseDown={(e) =>
                                                            onStartConnection(
                                                                  e,
                                                                  table.id,
                                                ...
                                                ></div>
                                                <div
                                                      className="hidden group-hover/row:block absolute -right-1.5 top-1/2 -translate-y-1/2 w-3 h-3 bg-blue-500 border-2 border-white dark:border-slate-800 rounded-full cursor-crosshair shadow-sm z-20 hover:scale-125 transition-transform"
                                                      onMouseDown={(e) =>
                                                            onStartConnection(
                                                                  e,
                                                                  table.id,
                                    ...
                                    >
                                          ...
                                          editingCell.field === "name" ? (
                                                ...
                                                <span
                                                      className={`${col.isPk ? "font-bold text-slate-800 dark:text-slate-100" : "text-slate-600 dark:text-slate-300"} hover:text-blue-600 dark:hover:text-blue-400 cursor-text`}
                                                >
                                                      {viewMode === "physical"
                                                            ? col.name
                                                            : col.logicalName}
                                    ...
                                    <div className="flex items-center gap-1 text-[9px] font-mono text-slate-400 dark:text-slate-500">
                                          ...
                                          {viewOptions.showNulls && (
                                                <span
                                                      className={`ml-1 ${col.isNullable ? "text-blue-300 dark:text-blue-700" : "text-slate-300 dark:text-slate-500 font-bold"}`}
                                                >
                                                      {col.isNullable
                                                            ? "NULL"
                                                            : "NN"}
                        ...
                        {isConnecting &&
                              ...
                              tempConnection.sourceTableId !== table.id && (
                                    ...
                                    >
                                          <CopyPlus
                                                size={14}
                                                className="text-green-600 dark:text-green-400 mr-1.5"
                                          />
