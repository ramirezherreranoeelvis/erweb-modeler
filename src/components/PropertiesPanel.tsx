                                                            ...
                                                            <div className="flex gap-2 items-end">
                                                                  <div className="w-24 shrink-0 relative">
                                                                        ...
                                                                        <select
                                                                              ...
                                                                              className={`w-full text-[10px] py-1.5 px-1 border border-slate-300 dark:border-slate-600 rounded text-slate-700 dark:text-slate-200 outline-none ${isLinkedFk ? "bg-slate-100 dark:bg-slate-800 text-slate-400 dark:text-slate-500 cursor-not-allowed" : "bg-white dark:bg-slate-800"}`}
                                                                        >
                                                                              <option value="INT">
                                                                                    INT
                                                                              </option>
                                                                  ...
                                                                  <div className="flex flex-1 justify-end items-center gap-1.5 pb-0.5">
                                                                        ...
                                                                        <button
                                                                              ...
                                                                              className="flex flex-col items-center justify-center w-8 h-8 rounded border bg-white dark:bg-slate-800 border-slate-200 dark:border-slate-600 text-slate-300 dark:text-slate-500 hover:bg-red-50 dark:hover:bg-red-900/20 hover:border-red-200 dark:hover:border-red-800 hover:text-red-500 transition-all opacity-0 group-hover:opacity-100"
                                                                        >
                                                                              <Trash2
                                                                                    size={
                                                                                          14
